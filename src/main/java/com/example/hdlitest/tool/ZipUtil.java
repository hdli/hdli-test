...
public class ZipUtil {
    ...
    public static void toZip(String srcDir, String outPathFile,boolean isDelSrcFile) throws Exception {
        ...
        try (FileOutputStream out = new FileOutputStream(new File(outPathFile)); ZipOutputStream zos = new ZipOutputStream(out)) {
